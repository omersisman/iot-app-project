...
public class DeviceResource {
    ...
    public String create(String xToken, String brand, String customId, int deviceProfileId, int locationId,
                         String model, String name, int servedAppId, int vendorId, String status){
